...
namespace NewRelic.AgentConfiguration.FormElements
{
    public static class Methods
    {
        ...
        public static void MenuButton_MouseEnter(object sender, EventArgs e)
        {
            ...
            if (!MainForm.CurrentSection.Contains(menuButton.Text) || String.IsNullOrWhiteSpace(MainForm.CurrentSection))
            {
        ...
        public static void MenuButton_Click(object sender, EventArgs e)
        {
            ...
            MainForm.CurrentSection = "s" + menuButton.Text;
