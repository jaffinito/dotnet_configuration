...
namespace NewRelic.AgentConfiguration.Core
{
    ...
    public static class SpecialCaseHandlers
    {
        ...
        /// </summary>
        private static readonly List<string> SpecialLengthNames = new List<string>() { 
                "log.directory", 
                "log.fileName", 
        ...
        /// </summary>
        private static readonly List<string> IsAdvancedNames = new List<string>(){
        ...
        /// <returns></returns>
        public static bool RootElement(Element parent)
        {
